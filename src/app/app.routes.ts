...
export const routes: Routes = [
  { path: '', component: BankersEntrepreneursComponent },
  {
    path: 'banking-payment-processing',
    component: BankingPaymentProcessingComponent,
  },

  { path: 'loan-providers', component: LoanProvidersComponent },
  { path: 'digital-banking', component: DigitalBankingComponent },
  {
    path: 'financial-service-provider',
    component: FinancialServiceProviderComponent,
  },
  //   { path: 'index-5', component: BankersEntrepreneursComponent },
  { path: 'social-finance-agency', component: SocialFinanceAgencyComponent },
  { path: 'currency-transfer-provider', component: CurrencyTransferProviderComponent },
